...
One Student can have one Department , One Department can have many Students. 
Department is the parent entity and Student is the child entity.
Among Department and Student there is a one to many relationship.
Among Student and Department there is a many to one relationship.
Here I have mapped this relationship as a bidirectional relationship.
